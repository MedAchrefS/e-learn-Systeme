...
router.post('/register', function(req, res, next) {
  ...
  if(errors){
      ...
      if(type== 'student'){
        console.log('Regestring student');
        ...
        console.log('Regestring instructor');

        var newInstructtor= new Instructor({
          first_name:first_name,
          last_name:last_name,
          adresse:[{
                street_address: street_address,
      ...
      User.saveInstructor(newUser,newInstructtor,function(err,user){
...
// user login serielze passport plugin
